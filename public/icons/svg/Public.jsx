...
const Public = ({ color, size }) => {
    return (
        <svg viewBox="0 0 16 16" width={size} height={size} fill={color} title="Shared with Public" className="x19dipnz x1lliihq x1k90msu x2h7rmj x1qfuztq" style={{ '--color': color }}>
