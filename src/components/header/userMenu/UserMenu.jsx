...
const UserMenu = ({ user }) => {
  ...
  const handleClick = (event, visibility) => {
    event.stopPropagation();
    setVisible(visibility);
  }

  return (
    <div className="mmenu" onClick={(e) => e.stopPropagation()}>
      {visible === 0 && <>
        <div>
          ...
          <div className="mmenu_splitter"></div>
          <div className="mmenu_item hover3" onClick={(e) => handleClick(e, 1)}>
            <div className="small_circle">
          ...
          <div className="mmenu_item hover3" onClick={(e) => handleClick(e, 2)}>
            <div className="small_circle">
              <IoMdHelpCircle />
            </div>
          ...
          <div className="mmenu_item hover3" onClick={(e) => handleClick(e, 3)}>
            <div className="small_circle">
              <MdDarkMode />
            </div>
